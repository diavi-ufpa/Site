...
export default function TecnicoFilters({
  ...
  const isAnyFilterActive =
    ...
    (selectedFilters?.exercicio && selectedFilters.exercicio !== 'todos') ||
  ...
  const handleClearFilters = () => {
    ...
    onFilterChange({ target: { name: 'exercicio', value: 'todos' } });
    ...
    <div className="filtersContainer">
      ...
      <div className="stepGrid">
        ...
        <div className="stepCard">
          <label className="stepLabel" htmlFor="tecnico-lotacao">
        ...
        {/* Passo 2: Unidade de Exercício */}
        <div className="stepCard">
          <label className="stepLabel" htmlFor="tecnico-exercicio">
            <span className={`stepBadge ${selectedFilters?.exercicio && selectedFilters.exercicio !== 'todos' ? 'stepBadgeActive' : ''}`}>
              2
            </span>
            Unidade de Exercício
          </label>
          <select
            id="tecnico-exercicio"
            name="exercicio"
            value={selectedFilters?.exercicio || 'todos'}
            onChange={handleChange}
            className="customSelect"
          >
        ...
        {/* Passo 3: Cargo */}
        <div className="stepCard">
          <label className="stepLabel" htmlFor="tecnico-cargo">
        ...
        {/* Passo 4: Dimensão */}
        <div className="stepCard">
          <label className="stepLabel" htmlFor="tecnico-dimensao">
        ...
        <div className="stepCard stepCardWide">
          <label className="stepLabel" htmlFor="tecnico-pergunta">
